      ...
      <div>
        ...
        {!this.state.similarImage ? (
          <div style={{ marginTop: '0rem' }}>
            <Jumbotron
              serviceName="The Perfect Match"
  
          description="The Perfect Fit is an app created using IBM's cloud platform IBM Bluemix. Using Bluemix, we have worked with the Watson Visual Recognition tool which analyses data in images. We used this platform for creating our app allowing users to import images of streetwear and fashion seen in the day to day world. Just import an image and Watson will analyse it and find the items closest match. From there, you will be directed to leading fashion retailers and be enabled to purchase within a few clicks of a mouse!"
            />
            <section className="_full-width-row home">
              <div className="_container _container_large">
                <ImagePicker
                  ...
                  multiple={false}
                  maxSize={2000000}
                  accept=".png, .gif, .jpg, .jpeg, image/png, image/x-png, image/gif, image/jpeg, image/jpg"
                />
                <SimilarImages
